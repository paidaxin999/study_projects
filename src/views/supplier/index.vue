		...
		<!-- 查询表单 -->
				<el-form :inline="true" :model="SearchMapper" ref="SearchMapper" class="demo-form-inline" style="margin-top: 20px;">
				  <el-form-item prop="company">
				    <el-input v-model="SearchMapper.company" placeholder="供应商名称"></el-input>
				  </el-form-item>
				  <el-form-item prop="name">
				    <el-input v-model="SearchMapper.name" placeholder="联系人"></el-input>
				  </el-form-item>
				  <el-form-item prop="phone">
				    <el-input v-model="SearchMapper.phone" placeholder="联系电话"></el-input>
				  </el-form-item>
				  <el-form-item>
				...
				<!-- 新增信息对话框 -->
				<el-dialog title="新增供应商" :visible.sync="dialogFormVisible" width="600px">
				  <el-form :model="pojo" label-position="right" :rules="rules" ref="pojo">
					...
					<el-form-item label="联系电话" :label-width="'100px'" prop="phone">
					 ...
					 <el-form-item label="备注" :label-width="'100px'" prop="remarks">
					    <el-input type="textarea" v-model="pojo.remarks"></el-input>
					  </el-form-item>
				  </el-form>
				...
				<el-table
				  ...
				  <!-- 编辑对话框 -->
				  <el-dialog title="编辑供应商" :visible.sync="editDialogVisible" width="600px">
...
<script>
	//导入api后台接口
	import {getCount,getsupplierlist,searchMapper,addsupplier,editsupplier,delsupplier} from '../../api/supplier.js';
